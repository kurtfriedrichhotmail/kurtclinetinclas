...
function createList() {
	...
	// run locally
    //$.get("http://localhost:7071/api/kurtwritecosmosinclas", function(data, status){ 
    
    
	// run on Azure
    $.get("https://kurtcosmosdatawriteinclass.azurewebsites.net/api/kurtwritecosmosinclas", function(data, status){ 
